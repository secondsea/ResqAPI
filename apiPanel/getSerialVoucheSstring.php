...
//var_dump ($project_path);
	...
	$panel->disPercent=$_POST['disPercent'];
//	$panel->disPercent=15;
	
	//
	
	
	$voucherDetail=$panel->getVouchers(); 
...
//  . $_POST['uniId'];
  ...
  $postback =array('msg' => $msg, 'value'=>$voucherDetail);
  
  
//, 'subtotal'=>$subTotal,'discount'=>$disAmount,'percent'=>$disPercent);
